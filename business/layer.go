...
func newLayer(
	...
	temporaryLayer.IstioConfig = IstioConfigService{conf: conf, discovery: discovery, userClients: userClients, saClients: kialiSAClients, kialiCache: cache, businessLayer: temporaryLayer, controlPlaneMonitor: cpm}
